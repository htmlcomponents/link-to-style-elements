...
function findStyleAndProcessLinkFragments(root, fragment, originalRoot = null) {
...
/**
 * Polyfill that resolves link fragments referencing style elements across shadow DOM boundaries
 */
function lrlrPolyfillStylesInShadows() {
...
if (typeof module !== "undefined" && typeof module.exports !== "undefined") {
  module.exports = { lrlrPolyfillStylesInShadows };
} else {
  // Make available globally when not using modules
  window.lrlrPolyfillStylesInShadows = lrlrPolyfillStylesInShadows;
}
